...
public val Icons.IconStarUnselected: ImageVector
    get() {
        if (_iconStarUnselected != null) {
            return _iconStarUnselected!!
        }
        _iconStarUnselected = Builder(
            name = "IconStarUnselected", 
    ...
    private var _iconStarUnselected: ImageVector? = null

    @Preview
    @Composable
    private fun Preview() {
        Box(modifier = Modifier.padding(12.dp)) {
            Image(imageVector = Icons.IconStarUnselected, contentDescription = null)
        }
    }
